...
set(gca,'LineWidth',2,'FontSize',25) 
hold off
legend('kp=0.2','kp=2.0','kp=20','kp=200')
...
plot(cellNum3,'LineWidth',5,'Color','g');
plot(cellNum4,'LineWidth',5,'Color','y');
% plot(tissueArea5,'LineWidth',5);
title('cell numbers');
set(gca,'LineWidth',2,'FontSize',25) 
hold off
legend('kp=0.1','kp=0.5','kp=1.0','kp=1.5')
...
plot(tmpCN3,tmpHvW3,'linestyle','none','marker','o','Color','g');
...
%save 'Jan4Advanced_pMadReg8.mat'
