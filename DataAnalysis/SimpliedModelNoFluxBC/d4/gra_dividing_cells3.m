...
%         end
    if fileNum<10
        filename = ['detailedStat_N03G00_0000' num2str(fileNum) '.txt'];
    elseif fileNum<100
        filename = ['detailedStat_N03G00_000' num2str(fileNum) '.txt'];
    elseif fileNum<1000
        filename = ['detailedStat_N03G00_00' num2str(fileNum) '.txt'];
    else
        filename = ['detailedStat_N03G00_0' num2str(fileNum) '.txt'];
    end
